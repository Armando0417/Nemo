...
// -- Config -------------------------------------------------------
constexpr const char *JF_EXE = R"(D:\Wandering_Sea\Den_Branch\Sarcophagus\VoyagerRecords\engine\jellyfin.exe)";
constexpr const char *JF_DATA = R"(D:\Wandering_Sea\Den_Branch\Sarcophagus\VoyagerRecords\configurations\data)";
constexpr const char *JF_CACHE = R"(D:\Wandering_Sea\Den_Branch\Sarcophagus\VoyagerRecords\configurations\cache)";
constexpr const char *JF_LOGS = R"(D:\Wandering_Sea\Den_Branch\Sarcophagus\VoyagerRecords\configurations\logs)";
constexpr const char *SERVE_DIR = R"(D:\Wandering_Sea)";
constexpr int JF_PORT = 1977;
constexpr int HTTP_PORT = 12501;

// gate_loader.html URL with params pre-filled for this gate
constexpr const char *GATE_URL =
    "http://localhost:12501/gate_loader.html"
...
void printTitle()
{
    ...
    std::cout << "  ===================================================\n";
    std::cout << "\n";
    std::cout << "          V O Y A G E R   R E C O R D S\n";
    std::cout << "          -------------------------------\n";
...
int main()
{
    ...
    // (python -m http.server 12501 from D:\Wandering_Sea)
